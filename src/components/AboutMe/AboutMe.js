...
и дочь. Я люблю слушать музыку, а ещё увлекаюсь бегом. Недавно начал кодить. С 2015 года работал в компании «СКБ Контур». После того, как прошёл курс по веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной работы.</p>
          ...
          <div className="about-me__links">
            <a rel = "noreferrer" target="_blank" className="about-me__link" href="https://www.facebook.com/timofey.berezhnov/">Facebook</a>
            <a rel = "noreferrer" target="_blank" className="about-me__link" href="https://github.com/timofeus91">Github</a>
          </div>
        </div>
